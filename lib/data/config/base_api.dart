...
var BASE_URL = "https://api.theequilibra.com/users-api";
class BaseApi {
  final BASE_URL =  "https://api.theequilibra.com/users-api";// "https://api.equilibra-admin.test.natterbase.com/users-api";
